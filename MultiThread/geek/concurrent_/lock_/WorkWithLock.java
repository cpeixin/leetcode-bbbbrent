 ...
 * @version: 
 * @Author: Brent
 * @Date: 2022-12-21 22:02:08
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2022-12-21 22:26:49
 * @Descripttion: 
 */
...
/**
 * Lock 对标 synchronized
 */
public class WorkWithLock implements Runnable {

    // TODO ReentrantLock
    // 顾名思义，就是可以重复进入的锁，说人话就是一个线程获取到锁之后，可以再一次次的获取锁，ReentrantLock只是给它来个计数而已。而第一次没有获取锁的线程，则无法进入锁
